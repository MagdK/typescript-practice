const anchor = document.querySelector('a')!; // this value might be null because typscript does not know if there is an anchor tag during development. It doesn't have access to index.html
